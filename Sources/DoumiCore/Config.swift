...
public struct GlobalConfig: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case dryRun = "dry_run"; case logLevel = "log_level"
    }
}
...
public enum MatchMode: String, Codable { case all, any }
...
public struct Condition: Codable {
    ...
    public var newerThan: String?; public var basis: AgeBasis?; public var run: String?

    enum CodingKeys: String, CodingKey {
        case type, glob, regex, contains, run, not
        ...
        case gt, lt, gte, lte; case olderThan = "older_than"; case newerThan = "newer_than"
        case basis
    }
}
...
extension Action {
    public init(from decoder: Decoder) throws {
        ...
        createDirs = try c.decodeIfPresent(Bool.self, forKey: .createDirs)
        onConflict = try c.decodeIfPresent(ConflictStrategy.self, forKey: .onConflict)
